...
import 'package:ulangan_flutter/pages/rotating%20features/history_page_layout/history_landscape.dart';
import 'package:ulangan_flutter/pages/rotating%20features/history_page_layout/history_potrait_layout.dart';
      ...
      body: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return Obx(() => layoutController.isMobile.value
              ? HistoryPortraitLayout()
              : HistoryLandscapeLayout());
        },
      ),
    );
  }
